...
public class ViewAllPopularAdapter extends RecyclerView.Adapter<ViewAllPopularAdapter.MyViewHolder>  {
    private Context context;
    private List<BookModel> bookList;


    public ViewAllPopularAdapter(Context context, List<BookModel> bookList) {
    ...
    @NonNull
    @Override
    public ViewAllPopularAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_view_popular, parent, false);
        return new ViewAllPopularAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewAllPopularAdapter.MyViewHolder holder, int position) {
